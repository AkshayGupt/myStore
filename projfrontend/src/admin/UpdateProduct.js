...
import { getCategories,addProduct, updateProduct, getProduct } from './helper/adminapicall';
      ...
      const onSubmit = (event) => {
            ...
            .then(data=>{
                if(data.error){
                    ...
                    setValues({...values,name:"",description:"",price:"",photo:"",stock:"",loading:false,createdProduct:data.name,getRedirect:true});
                }
            })
